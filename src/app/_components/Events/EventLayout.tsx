    ...
    <div className="bg-white px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
      <div className="relative mx-auto max-w-lg divide-y-2 divide-gray-200 lg:max-w-7xl">
        <div className="mt-6 grid gap-16 pt-10 lg:grid-cols-2 lg:gap-x-5 lg:gap-y-12">
          <div key={event?.title}>
            {featuredTitle ? (
              <p className="pb-5 text-sm font-medium text-green-700">
                <Link
                  href={`/events/${encodeURIComponent(mainEventSlug)}`}
            ...
            <div className="mt-3">
              <Link
                ...
                className="flex text-base font-semibold text-blue-600 hover:text-indigo-500 hover:underline"
              >
