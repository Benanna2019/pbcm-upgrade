...
export default function Calendar({ calendarEvents }: any) {
  ...
  // if (isLoading) {
  //   return (
  //     <div className="flex h-52 flex-1 items-center justify-center">
  //       <LoadingSpinner />
  //     </div>
  //   )
  // }
  ...
  const selectedDayMeetings = calendarEvents.filter((event: any) => {
    return isSameDay(parseJSON(event.startDate), selectedDay)
  })

  return (
    <div className="pt-16 ">
      <div className="mx-auto max-w-lg px-4 sm:px-7 md:max-w-6xl md:px-6">
