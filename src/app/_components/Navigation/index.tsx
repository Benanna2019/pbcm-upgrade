              ...
              <NavigationMenuContent>
                <ul className="tex grid gap-3 p-6 sm:w-[200px] md:w-[400px] lg:w-[700px] lg:grid-cols-[.75fr_1fr]">
                  ...
                  <ListItem href="/biblical-counseling" title="Introduction">
                    ...
                    on the power of the Holy Spirit, prayer, and the
                    sufficiency, inerrancy, immutability, and the authority of
                    the Holy Scripture (Sola Scriptura) as the lens by which
