        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-prose text-lg">
            ...
            <p className="mt-8 text-xl leading-8 text-gray-500">
              <strong className="pr-2 text-gray-900">Our Mission:</strong>
            </p>
            <p className="mt-8 text-xl leading-8 text-gray-500">
            ...
            <p className="mt-8 text-xl leading-8 text-gray-500">
              <strong className="pr-2 text-gray-900">About Our Beliefs:</strong>
            </p>
            <p className="mt-8 text-xl leading-8 text-gray-500">
            ...
            <p className="mt-8 text-xl leading-8 text-gray-500">
              <strong className="pr-2 text-gray-900">We Believe:</strong>
            </p>
            <ol className="mx-auto mt-8 max-w-2xl list-decimal text-xl leading-8 text-gray-500">
              <li>
            ...
            <p className="mt-8 text-xl leading-8 text-gray-500">
              <strong className="pr-2 text-gray-900">
            ...
            <p className="mt-8 text-xl font-bold leading-8 text-gray-900">
              Biblical Counselors fulfill this by:
            </p>
            <ol className=" mx-auto mt-8 max-w-2xl list-disc text-xl leading-8 text-gray-500">
              <li>
            ...
            <p className="mt-8 text-xl font-semibold leading-8 text-gray-500">
              Areas of Biblical Counseling Certification and Continuing
              Education:
            </p>
            <p className="text-l mt-8 font-semibold leading-8 text-blue-500">
              -{' '}
              <a
